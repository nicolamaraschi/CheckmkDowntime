...
from mangum import Mangum  # Adapter per AWS Lambda
...
# Crea l'app FastAPI
app = FastAPI(title="Checkmk Downtime API (Serverless)")
...
origins = [
    ...
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "*" # In produzione su Lambda, spesso utile permettere * o specificare il dominio CloudFront
]
